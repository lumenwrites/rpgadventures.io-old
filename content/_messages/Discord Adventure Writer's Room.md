...
```
Hey, @everyone! Who's free to do some brainstorming tomorrow, Wed 9th, at 9PM GMT?

We will try to make a short, lighthearted, low-combat, system-agnostic adventure.
...
> Also, I want to screencast our brainstorming process and upload it to youtube. We don't need to do anything differently, I just want to be able to share our process with other people. If at the end of the session anyone isn't comfortable with uploading the video, I'll delete it.
```
...
## After brainstorm
```
Hey, thanks a lot for participating in the brainstorm! I hope you've enjoyed it. It's been really fun brainstorming with you, I'd love to see you in our future sessions.
