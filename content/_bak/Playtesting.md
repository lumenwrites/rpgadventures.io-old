...
<!-- 
Use this list for inspiration, but don't hesitate to invent your own ideas:
![](/mirage/talents.png)
...
<!--
- **Vampirism**  
I can turn into a bat, walk on walls, and regain strength by drinking the blood of my victims, but I get hurt by direct sunlight, can't walk into houses uninvited, and must feed at least once per day.  
-->
...
<!--
### Connections
You’re on good terms with a group of people (choose one). They’ll do their best to help you out when they can.
-->
...
<!--
### Quick Reflexes
You're fast enough to catch an arrow mid-flight.

### Superhuman Agility
You're as agile as Spider Man.

### Silent Step
Once per scene you can move with perfect silence. You can't be noticed when silence alone is enough to let you pass undetected.
...
<!--
### Master Pilot
You can drive or pilot any vehicle.
-->
...
Normally, abilities don't interact with rolls. 
- You don't need to roll to see whether you can use an ability (you can't fail to cast a fireball or shoot a grappling hook gun).
- And unlike talents, abilities don't give you advantage on rolls

They give you a narrative permission to do the extraordinary thing they are describing.

the exception is abilities that give you advantage in certain circumstances.
or abilities that require a roll if you've designed them this way.
...
The exception is when you intentionally design an ability to have a limitation that makes it unpredictable, like an ability to summon a rampaging monster that turns against you if you roll below 5.
